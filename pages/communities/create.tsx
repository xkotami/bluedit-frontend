...
const CreateCommunityPage: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (!userData) return;
            const response = await communityService.createCommunity(name.trim(), description.trim(), userData.token);
            ...
            if (communityResponse) {
                ...
                setError(communityResponse.error || 'Failed to create community');
            }
        } catch (err) {
